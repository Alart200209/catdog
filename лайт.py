...
# Создание нового вывода на основе MobileNetV2
...
model.save('cat_dog_classifier_mobilenetv2_150x150.h5')
...
tflite_model_path = 'cat_dog_classifier_mobilenetv2_150x150.tflite'
with open(tflite_model_path, 'wb') as f:
    f.write(tflite_model)

print(f"TensorFlow Lite модель сохранена по пути: {tflite_model_path}")
